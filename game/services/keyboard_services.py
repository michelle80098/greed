...
# Thanks to Brother Manley for much of this code to then be reworked into GREED.
...
class KeyboardService:
    ...
    def get_direction(self):
        ...
        # If directional movement other that L,R is desired uncomment the following
